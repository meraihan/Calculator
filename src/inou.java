 ...
 */
public class inou extends javax.swing.JFrame {

    /**
     * Creates new form inou
     */
    public inou() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inou.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
